...
- 已实现 Model-only Code Review Benchmark v2：SWE/Martian 独立适配器和版本化 prompt、严格 decision/schema 解析、明确标记的 common-100k-char-v1 上下文协议、SWE 500/1384 与 Martian 50 冻结 profile 及 `validate-selection`。
