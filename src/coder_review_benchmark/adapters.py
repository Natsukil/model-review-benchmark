...
from .context_policy import apply_context, messages_sha256
...
class SWEReviewAdapter:
    ...
    def prepare(self, task: dict, context_policy: str = "common-100k-char-v1") -> ReviewInput:
        ...
        return ReviewInput(messages, PROMPT_VERSION, self.prompt_sha256, ctx.original_chars, ctx.final_chars, ctx.truncated, ctx.reason, ctx.original_tokens, ctx.final_tokens, ctx.sha256, messages_sha256(messages))
